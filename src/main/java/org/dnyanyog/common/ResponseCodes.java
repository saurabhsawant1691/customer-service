...
public enum ResponseCodes {
  ...
  //	public final static String ADD_CUSTOMER_DUPLICATE_PHONE_NUMBER_MESSAGE = "This phone number is
  // already used";
  //
  //	public final static String UPDATE_CUSTOMER_NOT_FOUND_EMAIL_CODE = "FAIL";
  //	public final static String UPDATE_CUSTOMER_NOT_FOUND_EMAIL_MESSAGE = "Customer not found with
  // this email";
  //
  //	public final static String UPDATE_CUSTOMER_NOT_FOUND_PHONE_NUMBER_CODE = "FAIL";
  //	public final static String UPDATE_CUSTOMER_NOT_FOUND_PHONE_NUMBER_MESSAGE = "Customer not found
  // with this phone number";
  //
  //	public final static String CUSTOMER_NOT_FOUND_CUSTOMER_ID_CODE = "FAIL";
  //	public final static String CUSTOMER_NOT_FOUND_CUSTOMER_ID_MESSAGE = "Customer not found with
  // this customer id";
  //
  //	public final static String UPDATE_CUSTOMER_SUCCESS_CODE = "Success";
  //	public final static String UPDATE_CUTOMER_SUCCESS_MESSAGE = "Customer data updated
  // successfully";
  //
